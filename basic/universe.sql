...
ALTER SEQUENCE public.usuario_user_id_seq OWNED BY public.usuario.usuario_id;
...
--
-- Name: usuario usuario_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.usuario ALTER COLUMN usuario_id SET DEFAULT nextval('public.usuario_user_id_seq'::regclass);
...
ALTER TABLE ONLY public.usuario
    ADD CONSTRAINT usuario_usernaame_password_key UNIQUE (name, password);
